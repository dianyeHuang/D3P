...
try:
    from models.robomimic.macros_private import *
except ImportError:
    from models.robomimic.utils.log_utils import log_warning
    import models.robomimic
    log_warning(
        "No private macro file found!"\
        "\nIt is recommended to use a private macro file"\
        "\nTo setup, run: python {}/scripts/setup_macros.py".format(models.robomimic.__path__[0])
    )
